...
public class Cal {
    ...
    static void mod(){
        ...
        System.out.println("Mod alan sayiyi giriniz: ");
        int number2 = scan.nextInt();
        int mod = number % number2;
        System.out.println(mod);

    }
    static void areaRectangular(){
        Scanner scan = new Scanner(System.in);
        ...
        System.out.println("Dikdörtgen alani: " + (shortEdge * longEdge));
        System.out.println("Dikdörtgen cevresi: " + 2 * (shortEdge + longEdge));
    }
